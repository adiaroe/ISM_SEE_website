...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  if (logged_in()) {
    $fname = $_POST['fname_sub'];mysqli_query($conn, "UPDATE login_data SET first_name = '$fname' WHERE unique_id = '$unique_id';");
    $lname = $_POST['lname_sub'];mysqli_query($conn, "UPDATE login_data SET last_name = '$lname' WHERE unique_id = '$unique_id';"); 
    $email = $_POST['email_sub'];mysqli_query($conn, "UPDATE login_data SET email_id = '$email' WHERE unique_id = '$unique_id';");
    //mysqli_query($conn, "UPDATE users_final SET fname = '$fname', lname = '$lname', email = '$email' WHERE unique_id = '$unique_id';");
    header("Location:my_acc.php");
  }
}
...
<form action="<?php $_SERVER['PHP_SELF']?>" method = "post" class="register">
            ...
            <fieldset class="row1">
                ...
                <p>
                    ...
                    <input type="text" name="skype" value="<?php if(isset($skype)) echo $skype;?>" />
            ...
            <fieldset class="row2">
                ...
                <p>
                    ...
                    <select name="branch_sub" value="<?php if(isset($branch)) echo $branch; ?>" required="<?php if(isset($branch)) echo "true"; ?>">
                        <option>
                        </option>
...
<legend>Employement Details</legend>
    ...
    <h3>Job Description</h3>
            <select >
                        ...
                        <option value="mtech" id="mtech">Electronics
                        </option>
